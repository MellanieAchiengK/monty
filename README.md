#0x19. C - Stacks, Queues - LIFO, FIFO: Monty Language Interpreter
...
- `utility_functions.c` - utility functions

-------------------

## Author
*Mellanie Achieng - [GitHub](http://github.com/MellanieAchiengK) 
